...
<script src="{{asset('js/slidercalidad.js')}}"></script>
<div class="container my-5">
<h4 class="text-center" >Editar Sliders de Calidad</h4>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form id="agregarslider">
            ...
            <input type="hidden" value="calidad" name="pagina" id="pagina">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
              ...
              <label>Imagen</label>
              <br>
              <img id="preview-img"width="350px" height="200px" src=""> 
